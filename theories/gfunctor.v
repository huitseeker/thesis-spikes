...
(* functor in some category of groups. The implementation proposed here is    *)
(* fairly basic, relying on first order function matching and on structure    *)
(* telescopes, both of which are somewhat limited and fragile. It should      *)
(* switch in the future to more general and more robust quotation matching.   *)
